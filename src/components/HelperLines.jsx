 ...
 * 
 * @param {Object} draggingNode - The node being dragged
 * @param {Array} allNodes - All nodes in the flow
 * @param {number} threshold - Snap threshold in pixels
 * @returns {Object} { horizontal, vertical, snapPosition }
 */
export const getHelperLines = (draggingNode, allNodes, threshold = 8) => {
  ...
  const draggingWidth = draggingNode.width || draggingNode.style?.width || 280;
  const draggingHeight = draggingNode.height || draggingNode.style?.height || 200;
